            ...
            for (int k = -1; k < 2; k++)
            {
                ...
                // Iterating around the pixel we are using as our center
                {
                    ...
                    if (i + k >= 0 && i + k < width && j + l >= 0 && j + l < height)
                    {
                        ...
                        matrix[j][i].rgbtRed = (sqrt(runningtotalx + runningtotaly));
                        // RED
                        runningtotalx = 0;
                        runningtotaly = 0;
                        // Initializng the Sobel Operators (x and y)
                        ...
                        matrix[j][i].rgbtGreen = (sqrt(runningtotalx + runningtotaly));
                        // GREEN
                        runningtotalx = 0;
                        runningtotaly = 0;
                        // Initializng the Sobel Operators (x and y)
                        ...
                        matrix[j][i].rgbtBlue = (sqrt(runningtotalx + runningtotaly));
                        // BLUE
                    }
                }
            }
